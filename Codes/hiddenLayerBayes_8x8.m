...
%         resizem(pixelDataSubset_Test,[size(pixelDataSubset_Test,1) numPixelNodes]);
    ...
    save('pixelDataSubset1_TrainRearrange_8x8.mat','pixelDataSubset_TrainNew');
    save('pixelDataSubset1_TestRearrange_8x8.mat','pixelDataSubset_TestNew');
else
...
%     keyboard;
    ...
    if(reminder == 0)
        CPD_string = sprintf('CPD_Pixel_EM_8x8_%d.mat',iter);
        CPD_Pixel_EM = CPD_Pixel;
        save(CPD_string,'CPD_Pixel_EM');
        CPD_string = sprintf('CPD_Hidden_EM_8x8_%d.mat',iter);
